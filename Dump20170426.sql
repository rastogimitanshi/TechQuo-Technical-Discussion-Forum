...
INSERT INTO `question` VALUES (1,123,'What?','2017-02-05 17:22:34',15),(2,123,'WHy?','2017-02-05 17:22:34',30),(3,123,'When','2017-02-05 17:22:34',3),(4,123,'How','2017-02-05 17:22:34',4),(7,123,'So?','2017-02-05 17:22:34',4),(9,123,'Work?','2017-02-05 17:22:34',1),(1155,123,'WHo?','2017-02-05 17:22:34',1),(1156,12350,'How to include servlet in a jsp ?','2017-03-20 06:42:44',0),(1157,12350,'  What is the default session time in a servlet?','2017-03-20 06:50:30',1),(1158,12350,'Are scriptlets a good practice to use?','2017-03-20 07:07:42',1),(1159,12350,'  Question about html and css','2017-03-20 07:10:29',0),(1160,12350,'  dummy question about html and css','2017-03-20 07:13:24',8),(1161,12350,'  Dummy question to test fucntionality','2017-03-25 10:23:17',4),(1162,12350,'Which framework is best for web development?                  ','2017-03-25 18:50:33',22),(1163,NULL,NULL,'2017-03-25 18:54:39',0),(1164,12353,'Validating HTML with external javascript.\r\nCan\'t seem to get the validation to work. I\'m not really sure what i\'m doing wrong at the moment. I need the username & password if blank an alert to come up and let you know. ','2017-04-26 15:35:35',3),(1165,12353,' 0\r\ndown vote\r\nfavorite\r\n	\r\n\r\nI have written some simple Linux shell script. Now I am trying to figure out is that can I have a GUI developed with python and trigger my shell scripts from the GUI. Is this possible. How can I do this. Any ideas or examples please.\r\nThanks.                    ','2017-04-26 15:37:56',4),(1166,12353,'I have an array containing a number or images, i want to display 4 images in the page and add a pagination to display other images when click. Any suggestion on how to do this?','2017-04-26 15:43:50',1),(1167,12354,'How do I format my posts using Markdown or HTML?                    ','2017-04-26 15:53:16',0),(1168,12354,'How to tune parameters of custom kernel function with pipeline in scikit-learn?','2017-04-26 15:54:40',0),(1169,12354,'MongoDB: Can\'t initiate replica set; \'has data already, cannot initiate set\'                    ','2017-04-26 15:55:20',0),(1170,12354,'How to use Kalman filter in Python for location data?                    ','2017-04-26 15:55:55',0),(1171,12354,'How are you supposed to install a Python library using azure webapp as template?                    ','2017-04-26 15:56:25',0),(1172,12354,'Implementing an efficient graph data structure for maintaining cluster distances in the Rank-Order Clustering algorithm                    ','2017-04-26 15:57:18',0),(1173,12354,'How to resize a GLUT window?                    ','2017-04-26 15:57:49',0);
...
INSERT INTO `tags` VALUES (1,'jsp'),(2,'css'),(2,'jsp'),(3,'html'),(4,'jsp'),(7,'html'),(9,'jsp'),(1155,'java'),(1160,'css'),(1160,'html'),(1161,'html'),(1161,'servlet'),(1162,'framework'),(1162,'web'),(1164,''),(1164,'Javascript'),(1165,''),(1165,'GUI'),(1166,''),(1166,'css'),(1167,'html'),(1168,'python'),(1169,''),(1169,'MongoDB'),(1170,''),(1170,'python'),(1171,''),(1171,'azure'),(1172,''),(1173,'GLUT');
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12355 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (123,'Default','Default',1,'abc',2,'xzy','User','2017-04-01 07:59:01','Default@gmail.com','tabloid','1995-10-12',NULL,NULL,'Activate',0,'Default','','',51,'Default',0,0),(12350,'Mitanshi','Rastogi',1,'Red',4,'Staring Cat','User','2017-04-01 08:06:43','mitanshi1995.mr@gmail.com','qwert','0016-05-17',NULL,NULL,'Activate',0,'India','Delhi','',38,'Student',2,4),(12351,'abc','def',1,'gef',4,'fre','User','2017-04-01 07:54:13','mitanshi_1995@gmail.com','qwerty',NULL,NULL,NULL,'Activate',0,NULL,NULL,NULL,0,NULL,0,0),(12352,'Dummy','User',1,'Orange',4,'Bad ppl','Admin','2017-04-01 07:45:37','mitanshi_1995@yahoo.com','asdfgh',NULL,NULL,NULL,'Activate',0,NULL,NULL,NULL,0,NULL,0,0),(12353,'Marion','Moseby',2,'Cody',3,'Lime','User','2017-04-26 15:43:51','moseby@yolo.com','zackandcody',NULL,NULL,NULL,'Activate',0,NULL,NULL,NULL,1,NULL,3,0),(12354,'Cody','Martin',1,'yo mama',3,'you crazy','User','2017-04-26 15:57:49','codydontcare@gmail.com','yoyocodyyo',NULL,NULL,NULL,'Activate',0,NULL,NULL,NULL,0,NULL,7,1);
...
INSERT INTO `user_ans_likes` VALUES (12354,'455');
...
-- Dump completed on 2017-04-26 21:31:37
